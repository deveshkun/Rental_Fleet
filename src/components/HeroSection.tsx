...
const HeroSection = () => {
  ...
  const goToCars = () => {
    toast({
      title: "🚗 Explore Rides",
      description: "Opening available rides...",
    });
    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Experience freedom on wheels. From quick city scooties and powerful bikes to
            comfortable cars, find the perfect ride for every journey at unbeatable prices.
          </motion.p>
